---
title: Setting up a browser worker
...
<Frame caption="The Supply Compute panel, ready to start with a single button.">
  <img src="/images/app/supply-compute.png" alt="The Supply Compute panel with its Start supplying button and live uptime, sessions, and Carrots earned tiles." />
</Frame>
