...
Every worker you run, browser or native, appears under **Settings** › **Workers** with a live status, so you can see at a glance whether it is connected and busy. For managing workers and their keys, see [Run a native worker](/user/compute/native-worker).
