...
Built-in tools do not show an approval prompt. bunny uses them the moment they help, without pausing to ask. Approvals only apply to your connected apps and tool servers. See [Tool approvals](/user/chat/permissions) for how that works.

## See what's available

Open a fresh chat and you'll see small chips near the composer, like "4 tools available". They preview which built-in tools bunny can currently reach.
