---
title: Connect apps and tool servers
...
Each server lists the tools it adds. You can toggle any server on or off, and remove servers you added. A **Base MCP** server comes pre-installed and is off by default, so switch it on if you want it.
